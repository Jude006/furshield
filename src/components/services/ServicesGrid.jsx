  ...
  const services = [
    {
      ...
      description:
        "Professional medical services, health checkups, and emergency care from certified veterinarians.",
      color: "bg-red-500",
    ...
    },
    {
      ...
      description:
        "Comprehensive wellness programs including grooming, nutrition, and preventive care.",
      color: "bg-pink-500",
    ...
    },
    {
      ...
      title: "Pet Insurance",
      description:
        "Financial protection and insurance plans to safeguard your pet's health and your budget.",
      color: "bg-blue-500",
    ...
    },
    {
      ...
      description:
        "Adoption services, shelter management, and community outreach programs for homeless pets.",
      color: "bg-green-500",
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg text-neutral-600 md:text-xl">
            Everything your pet needs for a healthy, happy life in one unified
            platform
          </p>
        </motion.div>
                ...
                <div>
                  ...
                  <ul className="mb-6 space-y-2">
                    {service.features.map((feature, featureIndex) => (
                      ...
                      >
                        <div
                          className={`w-1.5 h-1.5 rounded-full ${service.color} mr-3`}
                        ></div>
          ...
          <div className="grid grid-cols-2 gap-8 text-center md:grid-cols-4">
            {[
              ...
              <div key={index} className="p-6 bg-neutral-50 rounded-xl">
                <div
                  className={`text-2xl font-bold md:text-3xl ${stat.color} font-display`}
                >
                  {stat.number}
                </div>
