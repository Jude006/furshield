...
const VetDashboardNav = ({ setShowSideBar, showSideBar }) => {
    ...
    <nav className="flex items-center justify-between px-6 py-4 bg-white border-b border-neutral-200">
      <div className="flex items-center">
        ...
        <div className="ml-4 lg:ml-0">
          <h1 className="text-xl font-semibold text-neutral-800">Veterinarian Dashboard</h1>
          <p className="text-sm text-neutral-500">Manage your practice and patient care</p>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-4">
        <div className="items-center hidden space-x-6 md:flex">
          <div className="flex items-center space-x-2 text-sm text-neutral-600">
            ...
            <span>5 appointments today</span>
          </div>
          <div className="w-px h-6 bg-neutral-300"></div>
          <div className="text-sm text-neutral-600">
            <span className="font-medium text-green-600">12</span> patients this week
          </div>
        </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="hidden text-sm font-medium md:block text-neutral-700">Dr. Johnson</span>
          ...
          <AnimatePresence>
            {showProfileMenu && (
              ...
              >
                ...
                <a href="#" className="block px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-100">Schedule</a>
