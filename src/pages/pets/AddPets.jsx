  ...
  const addMedicalRecord = () => {
    setFormData({
      ...
      medicalHistory: [
        ...
        { condition: "", diagnosis: "", treatment: "", date: "" },
      ],
    });
  };
    ...
    try {
      ...
      Object.entries(formData).forEach(([key, value]) => {
        if (key === "medicalHistory") {
          const filteredHistory = value.filter(
            (record) =>
              record.condition ||
              record.diagnosis ||
              record.treatment ||
            ...
            >
              <div className="p-6 bg-white border shadow-sm rounded-xl border-neutral-200">
                <form onSubmit={handleSubmit}>
                  <h2 className="mb-6 text-xl font-bold text-neutral-900 font-display">
                    Pet Details
                  </h2>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div className="col-span-2">
                      ...
                      {formData.medicalHistory.map((record, index) => (
                        <div
                          key={index}
                          className="p-4 mt-2 border rounded-lg border-neutral-300"
                        >
                          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                              <label className="block font-sans text-sm font-medium text-neutral-600">
