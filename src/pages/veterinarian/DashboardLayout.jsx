...
import VetSidebar from '../../components/vets/Sidebar';
import VetDashboardNav from '../../components/vets/DashboardNav';
  ...
  return (
    <section className='flex min-h-screen bg-neutral-50'>
      {!isMobile && showSideBar && (
        ...
        >
          <VetSidebar setShowSideBar={setShowSideBar} />
        </motion.div>
      )}
      ...
      <main className={`w-full bg-white rounded-xl min-h-screen ${
        ...
        <VetDashboardNav setShowSideBar={toggleSideBar} showSideBar={showSideBar} />
        <div className="p-6">
          <Outlet />
        </div>
      </main>
